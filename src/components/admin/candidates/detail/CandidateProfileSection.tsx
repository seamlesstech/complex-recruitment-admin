...
export function CandidateProfileSection({
  ...
  return (
    <DetailCard title="Candidate profile">
      <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <DetailField label="Primary sector">{candidate.sector}</DetailField>
        <DetailField label="Registered">{registeredLabel}</DetailField>
        <DetailField label="Registration source">
          {candidate.source}
        </DetailField>
      </dl>
    </DetailCard>
